          ...
          <ul className="nav">
            ...
            <li className={this.activeRoute("/components")}>
              ...
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <NavLink to={'/admin/ingestionwizzard'} className="nav-link" activeClassName="active"><i className="icon-puzzle"></i> Carica</NavLink>
                </li>
                <li className="nav-item">
            ...
            <li className={this.activeRoute("/icons")}>
              ...
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <NavLink to={'/admin/ontologies'} className="nav-link" activeClassName="active"><i className="icon-star"></i> Ontologie</NavLink>
                </li>
                <li className="nav-item">
            ...
            <li className={this.activeRoute("/icons")}>
              ...
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <NavLink to={'/admin/dash'} className="nav-link" activeClassName="active"><i className="icon-star"></i> Crea Storia</NavLink>
                </li>
                <li className="nav-item">
            ...
            <li className="nav-item">
              <a href={'http://156.54.180.186:8080/tree?'} className="nav-link"  activeClassName="active"><i className="icon-pie-chart"></i> Data Science</a>
            </li>
          </ul>
        </nav>
      </div>
