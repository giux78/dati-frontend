        ...
        <nav className="sidebar-nav">
          <ul className="nav">
            ...
            <li className={this.activeRoute("/icons")}>
              ...
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <NavLink to={'/icons/font-awesome'} className="nav-link" activeClassName="active"><i className="icon-star"></i> Ontologie</NavLink>
                </li>
                <li className="nav-item">
            ...
            <li className={this.activeRoute("/icons")}>
              ...
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <NavLink to={'/icons/font-awesome'} className="nav-link" activeClassName="active"><i className="icon-star"></i> Crea Storia</NavLink>
                </li>
                <li className="nav-item">
